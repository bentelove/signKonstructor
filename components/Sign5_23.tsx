...
interface Props extends BaseSign {
    city: string;
    signType?: '5.23.1' | '5.23.2'; // Тип знака: начало или конец населенного пункта
}
...
export default function Sign5_23({ 
    baseData, 
    sizeType = 3, 
    width: containerWidth, 
    city,
    signType = '5.23.1' // По умолчанию знак "Начало населенного пункта"
}: Props) {
    ...
    return (
        ...
        >
            ...
            <rect 
                x={outlineWhite}
                y={outlineWhite}
                width={signWidth - 2 * outlineWhite}
                height={signHeight - 2 * outlineWhite}
                rx={signHeight * 0.08}
                ry={signHeight * 0.08}
                fill="#000000"
            />
